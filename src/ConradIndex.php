...
/**
 * ConradIndex class contains a method for calculating the continentality index using the Conrad method
 *
 * @author Dmytriyenko Vyacheslav <dmytriyenko.vyacheslav@gmail.com>
 */
class ConradIndex implements ContinentalIndexInterface
{
    /**
     * Returns the continentality index calculated using the Conrad method
     *
    ...
    {
        return round(((1.7 * $tempAmplitude) / sin(deg2rad($latitude + 10))), 2);
    }
